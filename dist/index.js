...
/** @class */
function () {
  function Logger(projectToken) {
    this.projectToken = projectToken;
  }

  Logger.prototype.add = function (loggerName, data) {
    axios_1.default.post('/api/add', {
      data: data,
      projectToken: this.projectToken
    });
  };

  Logger.prototype.get = function (loggerName, data) {
    var postData = {
      projectToken: this.projectToken
    };
    axios_1.default.get('/api/add', {
      params: {
        postData: postData
      }
    });
...
},{"axios":"../node_modules/axios/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
